...
p2=Picture.create(imageable: s2, name: 'Zelda')
p3=Picture.create(imageable: s3, name: 'Bufallo Roamer')
p4=Picture.create(imageable: s4, name: 'Lake')
p1=Picture.create(imageable: s1, name: 'Tank')
p5=Picture.create(imageable: s5, name: 'Pollack')
p6=Picture.create(imageable: s6, name: 'GlassBall')
p7=Picture.create(imageable: s7, name: 'SymmetricBuilding')
