...
p1=Picture.create(imageable: a1, title:'The Weezer')
p2=Picture.create(imageable: a2, title:'Tinker')
p3=Picture.create(imageable: a3, title:'Palinque')
p4=Picture.create(imageable: a4, title:'Nastor')
p5=Picture.create(imageable: a5, title:'Climate Change')
p6=Picture.create(imageable: a6, title:'Huew')
p7=Picture.create(imageable: a7, title:'Yodel-ay')
p8=Picture.create(imageable: a8, title:'Samsquanch')
p9=Picture.create(imageable: a9, title:'Hollow Springs')
p10=Picture.create(imageable: a10, title:'Cheeks')
p11=Picture.create(imageable: a11, title:'The Winter')
p12=Picture.create(imageable: a12, title:'Petre')
p13=Picture.create(imageable: a13, title:'Gong')
p14=Picture.create(imageable: a14, title:'XYn')
