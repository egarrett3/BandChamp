...
user2 = User.create(username: 'Ron', email: 'ron@ron.com', password:'pineapple')
user3 = User.create(username: 'Jim', email: 'jim@jim.com', password:'bastion')
user4 = User.create(username: 'Kyle', email: 'Kyle@Kyle.com', password:'lexLuther')

a1=Album.create(title: 'The One',artist_id:user1.id)
a2=Album.create(title: 'Dosie Doe',artist_id:user1.id)
a3=Album.create(title: 'Capital Tango',artist_id:user1.id)
a4=Album.create(title: 'Darlene',artist_id:user1.id)
a5=Album.create(title: 'Wrong Time',artist_id:user2.id)
a6=Album.create(title: 'Terrible Twos',artist_id:user2.id)
a7=Album.create(title: 'Locked n Loop',artist_id:user2.id)
a8=Album.create(title: 'the One',artist_id:user2.id)
a9=Album.create(title: 'Carrols',artist_id:user3.id)
a10=Album.create(title: 'Lost in Time',artist_id:user3.id)
a11=Album.create(title: 'Car Party',artist_id:user3.id)
a12=Album.create(title: 'Fa Gulan',artist_id:user3.id)
a13=Album.create(title: 'Sympony',artist_id:user4.id)
a14=Album.create(title: 'Le Don Jon',artist_id:user4.id)
