...
p2=Picture.create(imageable_id:'2', imageable_type:'Song', name: 'Zelda')
p3=Picture.create(imageable_id:'3', imageable_type:'Song', name: 'Bufallo Roamer')
p4=Picture.create(imageable_id:'4', imageable_type:'Song', name: 'Lake')
p1=Picture.create(imageable_id:'1', imageable_type:'Song', name: 'Tank')
p5=Picture.create(imageable_id:'5', imageable_type:'Song', name: 'Pollack')
p6=Picture.create(imageable_id:'6', imageable_type:'Song', name: 'GlassBall')
p7=Picture.create(imageable_id:'7', imageable_type:'Song', name: 'SymmetricBuilding')
